var detailview = $.extend({}, $.fn.datagrid.defaults.view, {
    addExpandColumn: function (target, index) {
        ...
        /*--------Begin add by loong 08/01/2011  
        fix datagrid-detailview header height--------*/
        $(body1).find('div.datagrid-header-inner').children("table").children().children().children("td").attr("height", "57px");
        /*--------End add by loong 08/01/2011  --------*/
        if (index >= 0) {
            _add(index);
    ...
    onBeforeRender: function (target) {
        ...
        var td = $('<td><div class="datagrid-header-expander" style="width:25px;"></div></td>');
        if ($('tr', t).length == 0) {
